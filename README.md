...
The application allows users to browse available sweets, search and filter them, and purchase sweets.
Admin users have additional privileges to manage the inventory, such as adding, updating, deleting, and restocking sweets.
